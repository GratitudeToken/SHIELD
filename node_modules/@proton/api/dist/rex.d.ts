import { ApiClass, RexBal, RexPool } from './index';
export declare function getRexQueued(this: ApiClass, account: string): Promise<any>;
export declare function getRexPool(this: ApiClass): Promise<RexPool>;
