...
var Hyperion = require('@proton/hyperion');
var LightApi = require('@proton/light-api');
var utils = require('@bloks/utils');
var fetch = _interopDefault(require('cross-fetch'));
var bignumber_js = require('bignumber.js');
var wrapConstants = require('@proton/wrap-constants');
var z = require('zod');
var numbers = require('@bloks/numbers');
            ...
            account.permissions = account.permissions.map(function (permission) {
              permission.required_auth.keys = permission.required_auth.keys.map(function (key) {
                if (key.key.indexOf(_this.constants.KEY_PREFIX) !== -1) {
                  key.key = js.Numeric.convertLegacyPublicKey(key.key, _this.constants.KEY_PREFIX);
                }
    ...
    return _regeneratorRuntime().wrap(function _callee4$(_context4) {
      while (1) {
        switch (_context4.prev = _context4.next) {
          ...
          case 5:
            return _context4.abrupt("return", this.get(utils.urlBuilder(this.constants.API_URL, 'hyperion', {
              type: 'get_creator',
              account: account
            })));
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 8:
            ...
            return _context.abrupt("return", utils.nativeTransformGetActions(result, this.constants));
      ...
      while (1) {
        switch (_context3.prev = _context3.next) {
          case 0:
            ...
            _context3.next = 6;
            return this.get(utils.urlBuilder(this.constants.API_URL, 'dfuse', {
              type: type,
              q: q,
          ...
          case 9:
            return _context3.abrupt("return", utils.dfuseTransformGetActions(result, accountName, this.constants));
    ...
    return _regeneratorRuntime().wrap(function _callee4$(_context4) {
      while (1) {
        switch (_context4.prev = _context4.next) {
          ...
          case 13:
            _context4.next = 15;
            return this.get(utils.urlBuilder(this.constants.API_URL, 'hyperion', {
              type: 'get_actions',
              account: account,
          ...
          case 18:
            return _context4.abrupt("return", utils.hyperionTransformGetActions(result));
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 13:
            ...
            throw new js.RpcError(data || 'Error');
        ...
        switch (_context.prev = _context.next) {
          case 0:
            ...
            return this.rpc.get_table_rows({
              ...
              code: 'fio.address',
              scope: 'fio.address',
              lower_bound: utils.encodeName(account, false),
              upper_bound: utils.encodeName(account, false),
              table: 'accountmap',
              limit: 1
            });
      ...
      while (1) {
        switch (_context3.prev = _context3.next) {
          case 0:
            ...
            _context3.next = 4;
            return utils.string_to_uint128_hash(name);
...
function getFIOAddresses(account) {
  return this.rpc.get_table_rows({
    ...
    limit: -1,
    lower_bound: utils.encodeName(account, false),
    upper_bound: new bignumber_js.BigNumber(utils.encodeName(account, false)).plus(1).toString(),
    index_position: 4
  }).then(function (result) {
      ...
      while (1) {
        switch (_context3.prev = _context3.next) {
          ...
          case 8:
            ...
            _context3.next = 11;
            return this.api.rawAbiToJson(utils.hexToUint8Array(action.data.abi));
        ...
        switch (_context5.prev = _context5.next) {
          case 0:
            ...
            return this.rpc.get_table_rows({
              ...
              scope: utils.encodeName(account_name, false),
              table: this.constants.EOSIO_MSIG_PROPOSALS_TABLE,
              table_key: '',
              key_type: 'name',
        ...
        switch (_context6.prev = _context6.next) {
          case 0:
            ...
            return this.rpc.get_table_rows({
              json: true,
              code: this.constants.EOSIO_MSIG,
              scope: utils.encodeName(account, false),
              table: table,
              limit: -1
            });
      ...
      while (1) {
        switch (_context5.prev = _context5.next) {
          ...
          case 6:
            ...
            more = result.more;
            rows = rows.concat(result.rows);
            lower_bound = new bignumber_js.BigNumber(utils.encodeName(rows[rows.length - 1].owner, false)).plus(1).toString();
      ...
      while (1) {
        switch (_context6.prev = _context6.next) {
          case 0:
            ...
            _context6.next = 6;
            return this.get(utils.urlBuilder(this.constants.API_URL, 'producers', {
              pageNum: pageNum,
              perPage: perPage
            }));
                              ...
                              while (1) {
                                switch (_context2.prev = _context2.next) {
                                  ...
                                  case 2:
                                    ...
                                    return _context2.abrupt("return", resolve(exports.KycStatus.PASSED));
                                  ...
                                  case 18:
                                    if (!(status === exports.KycStatus.PENDING)) {
                                      _context2.next = 22;
                                      break;
                                    }
...
var chainInfoParser = /*#__PURE__*/z.object({
  chainId: /*#__PURE__*/z.string(),
  explorerUrl: /*#__PURE__*/z.string(),
  explorerName: /*#__PURE__*/z.string(),
  resourceTokenSymbol: /*#__PURE__*/z.string(),
  resourceTokenContract: /*#__PURE__*/z.string(),
  systemTokenSymbol: /*#__PURE__*/z.string(),
  systemTokenContract: /*#__PURE__*/z.string(),
  rpcEndpoints: /*#__PURE__*/z.array( /*#__PURE__*/z.string()),
  actionsRpcEndpoints: /*#__PURE__*/z.array( /*#__PURE__*/z.string()),
  hyperionEndpoints: /*#__PURE__*/z.array( /*#__PURE__*/z.string()),
  lightEndpoints: /*#__PURE__*/z.array( /*#__PURE__*/z.string())
});
    ...
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 4:
            data = _context2.sent;
            return _context2.abrupt("return", wrapConstants.exchangeRatesParser.parse(data));
    ...
    return _regeneratorRuntime().wrap(function _callee3$(_context3) {
      while (1) {
        switch (_context3.prev = _context3.next) {
          ...
          case 5:
            data = _context3.sent;
            return _context3.abrupt("return", wrapConstants.withdrawalFeeQuoteParser.parse(data));
      ...
      while (1) {
        switch (_context3.prev = _context3.next) {
          ...
          case 7:
            ...
            if (more) {
              lower_bound = new bignumber_js.BigNumber(utils.encodeName(rows[rows.length - 1].to, false)).plus(1).toString();
            }
        ...
        switch (_context3.prev = _context3.next) {
          case 0:
            ...
            return this.rpc.get_table_rows({
              ...
              table: 'namebids',
              key_type: 'i64',
              lower_bound: lower_bound && lower_bound.length <= 12 ? utils.encodeName(lower_bound, true) : lower_bound,
              upper_bound: upper_bound && upper_bound.length <= 12 ? utils.encodeName(upper_bound, true) : upper_bound,
              index_position: 1,
              limit: -1
            });
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 2:
            ...
            lent_percent = numbers.multiply(numbers.divide(total_lent, total_lendable), 100);
            rex_price = +numbers.divide(total_lendable, total_rex);
            resource_price = +numbers.divide(total_unlent, total_rent + 1);
            return _context2.abrupt("return", {
      ...
      while (1) {
        switch (_context8.prev = _context8.next) {
          case 0:
            ...
            current_time = numbers.formatDate(numbers.utcTime());
            seven_days_ago = numbers.formatDate(numbers.utcTime(numbers.startDate(numbers.time(), 7)));
            _context8.next = 6;
            return this.post('https://www.api.bloks.io/graphql/v1alpha1/graphql', {
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            eosTransactions = new js.JsonRpc(this.constants.TRANSACTIONS_ENDPOINTS);
            _context.next = 4;
          ...
          case 7:
            return _context.abrupt("return", utils.historyTransformTransaction(tx));
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 2:
            ...
            return _context2.abrupt("return", utils.historyTransformDeferredTransaction(transactions[0]));
    ...
    return _regeneratorRuntime().wrap(function _callee3$(_context3) {
      while (1) {
        switch (_context3.prev = _context3.next) {
          ...
          case 11:
            return _context3.abrupt("return", utils.hyperionTransformTransaction(result));
      ...
      while (1) {
        switch (_context4.prev = _context4.next) {
          ...
          case 10:
            ...
            result = js.Serialize.transactionHeader(refBlock, expireSeconds);
...
function getControlledAccounts(accountName) {
  if (this.constants.HISTORY_TYPES.includes('native')) {
    ...
    var actionsRpc = new js.JsonRpc([this.constants.HYPERION_URL]);
      ...
      while (1) {
        switch (_context3.prev = _context3.next) {
          case 0:
            ...
            fioAccount = utils.fioKeyToActor(key.replace('EOS', 'FIO'), js.Numeric.stringToPublicKey);
    ...
    return _regeneratorRuntime().wrap(function _callee4$(_context4) {
      while (1) {
        switch (_context4.prev = _context4.next) {
          ...
          case 2:
            legacyPublicKey = js.Key.PublicKey.fromString(key).toLegacyString();
            _context4.next = 5;
...
var ApiClass = /*#__PURE__*/function () {
  function ApiClass(chain) {
    ...
    if (chain) {
      constants.constants.initialize(chain);
      this.initialize(constants.constants);
    }
  }
  ...
  _proto.initialize = function initialize(constants, _temp) {
    ...
    this.rpc = new js.JsonRpc(rpcEndpoints || this.constants.DEFAULT_ENDPOINTS);
    this.actionsRpc = new js.JsonRpc(actionsRpcEndpoints || this.constants.ACTIONS_ENDPOINTS);
    this.api = new js.Api({
      rpc: this.rpc
    });
    ...
    if (lightUrl) {
      this.lightApi = new LightApi.JsonRpc(this.constants.CHAIN.toLowerCase().replace('-', ''), {
        endpoint: lightUrl
      });
    }
