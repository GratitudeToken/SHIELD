...
export declare const createAbstractAuthParser: (contract: string, action: string, data: z.ZodRawShape) => z.ZodObject<{
    signer: z.ZodObject<{
        actor: z.ZodString;
...
declare const generateAuthActionsBaseParser: z.ZodObject<{
    account: z.ZodString | z.ZodLiteral<string>;
    name: z.ZodLiteral<string>;
    data: z.ZodObject<{
        time: z.ZodString;
...
export declare type GenerateAuthBaseAction = z.infer<typeof generateAuthActionsBaseParser>;
